...
- synthetic cases selected: 0
- synthetic pipeline status: `failed`
- historical state modified: no

## Run failure

- Provider/stage error: APIStatusError: Error code: 402 - {'error': {'message': 'Insufficient Balance', 'type': 'unknown_error', 'param': None, 'code': 'invalid_request_error'}}
- Interpretation: no candidate verdict is available; zero opportunities is not a corpus or eligibility conclusion.

## Run metrics

- total_source_segments_scanned: 273
- screened_for_difficulty: 48
- difficulty_opportunities_found: 0
...
None selected; the pipeline failed before eligibility decisions.

## Rejected synthetic cases

No rejection decisions were produced because the pipeline failed.
