...
- viable candidates: 26
- selected portfolio cases: 25
- tier distribution: `{"tier_1_core": 8, "tier_2_supporting": 13, "tier_3_contrast_boundary": 4}`
- provenance distribution: `{"project_grounded": 24, "historical_revision": 2, "synthetic": 1}`
- portfolio quality: `pass_with_warnings`
- composition validation: `pass`

## Taxonomy

The corpus produced 5 major problems and 13 subproblems:

- 源译对应与信息完整性: 段落错配、漏译与截断 / 审校证据与段落边界
- 词汇语义与形象表达: 语境化词义与搭配 / 比喻与形象表达 / 标题语义与形式
- 句法组织与逻辑关系: 修饰范围 / 论元关系与句法重组
