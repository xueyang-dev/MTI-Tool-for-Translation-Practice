...
本章对完整项目的 273<!--stat:segments_scanned--> 个段落进行全量扫描，从 31<!--stat:candidate_count--> 个候选中选择 25<!--stat:selected_case_count--> 个案例。案例数量并非目标本身；筛选优先考虑问题覆盖、机制差异、证据质量与章节递进。

本章把证据类型与分析篇幅分开。真实修订案例（Authentic Revision Case）只指保存了真实初译至终译变化的段落；审校支持例（Supporting Example）只说明当前译文与已记录审校发现；证据边界例（Boundary Case）用于说明证据失配或污染；合成对比案例（Synthetic Contrast Case）则是从真实源段构造、并经过独立资格检查的分析性对比。审校支持例不得写成历史修订，合成案例也不得写成作者初译。
...
**段落错配、漏译与截断（seg-ec100d8686d3891e-0209，核心案例）**
...
**段落错配、漏译与截断（seg-ec100d8686d3891e-0239，支持例）**
...
**段落错配、漏译与截断（seg-ec100d8686d3891e-0142，对照/边界例）**
...
**段落错配、漏译与截断（seg-ec100d8686d3891e-0144，对照/边界例）**
...
**审校证据与段落边界（seg-ec100d8686d3891e-0152，对照/边界例）**
...
**语境化词义与搭配（seg-ec100d8686d3891e-0056，支持例）**
...
**语境化词义与搭配（seg-ec100d8686d3891e-0057，支持例）**
...
**语境化词义与搭配（seg-ec100d8686d3891e-0080，支持例）**
...
**语境化词义与搭配（seg-ec100d8686d3891e-0081，支持例）**
...
**比喻与形象表达（seg-ec100d8686d3891e-0139，核心案例）**
...
**标题语义与形式（seg-ec100d8686d3891e-0119，支持例）**
...
该例作为 Supporting Example，补充说明同一机制：同时处理标题的语义核心、并列结构与文体凝练度。它记录的是审校问题，而不是已经发生的修订；审校建议只能作为分析性备选。
...
**修饰范围（seg-ec100d8686d3891e-0170，核心案例）**
...
**论元关系与句法重组（seg-ec100d8686d3891e-0234，核心案例）**
...
**专业术语与技术规范（seg-ec100d8686d3891e-0059，核心案例）**
...
**专业术语与技术规范（seg-ec100d8686d3891e-0082，支持例）**
...
**人名、地名与机构名一致性（seg-ec100d8686d3891e-0215，核心案例）**
...
**人名、地名与机构名一致性（seg-ec100d8686d3891e-0140，支持例）**
...
**人名、地名与机构名一致性（seg-ec100d8686d3891e-0141，支持例）**
...
**人名、地名与机构名一致性（seg-ec100d8686d3891e-0156，支持例）**
...
**人名、地名与机构名一致性（seg-ec100d8686d3891e-0235，支持例）**
...
**作品名与文化专名（seg-ec100d8686d3891e-0233，核心案例）**
...
**作品名与文化专名（seg-ec100d8686d3891e-0216，支持例）**
...
**回指与主语追踪（seg-ec100d8686d3891e-0272，核心案例）**
...
**问题与证据**：保存记录证明这里存在真实初译至终译变化，实际差异为“这五个字”→“这句话”。源文后句明确写有 ‘Those five words’，但可见英文引语按空格分词为六词；中文引语‘你不会经历战争’为七个汉字，初译‘这五个字’因而在目标语表层产生可直接核对的计数不一致。

**调整机制与效果**：终译把数字回指改为对整句话语的回指，消除了中文引语与‘五个字’之间的表层冲突。该效果可由两版译文直接比较，但历史动机未记录。

**证据边界**：本例不解释源文为何使用 five，也不声称可见英文引语恰好五词；现有记录不支持推断修订者的心理意图。
...
**叙事声音与对话节奏（seg-ec100d8686d3891e-0083，支持例）**
...
该例作为 Supporting Example，补充说明同一机制：用符合人物关系和叙事速度的报告语、口语结构与节奏组织对话。它记录的是审校问题，而不是已经发生的修订；审校建议只能作为分析性备选。
...
组合结果表明，局部词语选择只是问题的一层；段落对应、修饰辖域、逻辑关系、专名政策、回指链与人物语气会在不同层面共同影响译文。核心案例负责建立机制，审校支持例用于检验同一机制在其他语境中的表现，证据边界例则阻止不可靠证据进入结论。
