...
- selected portfolio cases: 27
- tier distribution: `{"tier_1_core": 12, "tier_2_supporting": 11, "tier_3_contrast_boundary": 4}`
- provenance distribution: `{"project_grounded": 26, "historical_revision": 2, "synthetic": 1}`
...
- 指称衔接、叙事声音与语用力度: 回指与主语追踪 / 反问、态度与语用力度
