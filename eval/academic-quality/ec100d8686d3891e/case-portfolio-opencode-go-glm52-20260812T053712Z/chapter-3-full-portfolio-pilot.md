...
本章对完整项目的 273<!--stat:segments_scanned--> 个段落进行全量扫描，从 31<!--stat:candidate_count--> 个候选中选择 27<!--stat:selected_case_count--> 个案例。案例数量并非目标本身；筛选优先考虑问题覆盖、机制差异、证据质量与章节递进。
...
**语境化词义与搭配（seg-ec100d8686d3891e-0142，tier_3_contrast_boundary）**
...
**专业术语与技术规范（seg-ec100d8686d3891e-0080，tier_2_supporting）**
...
<!--portfolio-case:seg-ec100d8686d3891e-0155-->

**人名、地名与机构名一致性（seg-ec100d8686d3891e-0155，tier_2_supporting）**

> [SOURCE_EXCERPT seg-ec100d8686d3891e-0155]: We held hands and walked down the slope, which everyone called “the Incline,” looking for jujubes.

> [TARGET_EXCERPT seg-ec100d8686d3891e-0155]: 我们手牵着手，沿着那个被大家称为“斜坡”的山坡走下去，寻找枣子。

> [REVIEW_FINDING seg-ec100d8686d3891e-0155]: 原文中“the Incline”是专有名称（特指某处地名），译文将其译为“斜坡”并加引号，虽保留了引号，但“斜坡”作为普通名词可能削弱其专有性；建议保留原文或音译加注，以体现其作为地名的特殊性。
...
**反问、态度与语用力度（seg-ec100d8686d3891e-0083，tier_1_core）**
...
**问题机制与错误诱因**：源文表面对应关系可能掩盖语境、搭配、结构或指称上的约束；本例需要按以下机制核对：区分真实询问与反问等言语行为，保持态度、对抗性和人物刻画。
