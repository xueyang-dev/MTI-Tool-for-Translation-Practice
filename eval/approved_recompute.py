...
输出 eval/reports/300seg_recomputed_with_approved_glossary.json / .md，
...
用法：
    python eval/approved_recompute.py \
        ...
        --out eval/reports/300seg_recomputed_with_approved_glossary.json
"""
...
def main(argv=None) -> int:
    ...
    ap.add_argument("--out",
                    default="eval/reports/300seg_recomputed_with_approved_glossary.json")
