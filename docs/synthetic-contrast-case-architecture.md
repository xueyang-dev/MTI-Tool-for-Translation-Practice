...
该次历史运行的 mixed selection 曾包含 0209、0272 和 SC-0141；后续完整性审计已确认
0209 是系统错位重译而非真实翻译修订，因此该选案结论已失效。翻译审校收口后的正式真实
核心案例为 0139、0233、0272，SC-0141 仍只是可选合成补充。SC-0141 展示
`What do you need that Ben-Gurion for?` 从中性信息问句“你为什么需要……”到带有驳斥意味的
“你要……干什么”的语用修复。该案例只能说明一种经验证的合理失败模式，不代表作者历史初译，
也不支持人类错误频率结论。该历史隔离运行没有修改当时的 `state.json` 或生产 TM；后续
翻译审校变更另有完整备份、finding裁决和system action记录。
